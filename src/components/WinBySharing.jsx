...
<span className="text-[#f9c306] uppercase font-poppins text-center font-medium text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">Starting from 23.05.2025 2pm CET!</span>
          ...
          <span>Note: $25,000 will be distributed into different trenches via social media and tasks</span>
          <span>Participation in this giveaway constitutes acceptance of the <span className="text-[#FFC600]"><a target="_blank" href="https://docs.google.com/document/d/1cUPESAa5Z6RHhb32BeDZnuX9q_oyPzjBqzKSg48I8Xo/edit?tab=t.0">Terms and Conditions</a></span></span>
        </div>
      </div>
    </div>
  );
